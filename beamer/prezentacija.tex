...
% Zajednički podatci iz pisanog rada.
\input{../GFRI-Template/podaci.tex}
...
\title{\naslov}
\subtitle{\vrsta{} -- \kolegij}
\author{\autor}
\institute{\studij{} studij, \smjer\\Sveučilište u Rijeci, Građevinski fakultet}
\date{Rijeka, \the\year.}
...
\ifGFRIprojekt
  \section*{Pripadnost projektu}

  \begin{frame}{Pripadnost projektu}
    \begin{columns}[c,onlytextwidth]
      \begin{column}{0.72\textwidth}
        Rad je izrađen u sklopu znanstvenog projekta.
      \end{column}
      \begin{column}{0.24\textwidth}
        \raggedleft
        \GFRIpartnerlogos{0.95cm}
      \end{column}
    \end{columns}
